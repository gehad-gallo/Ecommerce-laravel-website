                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/dashboard.shipping_methods')}}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{route('shipping_method','inner')}}">{{__('admin/dashboard.inner_shipping')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping_method','outer')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{__('admin/dashboard.outer_shipping')}}</a>
                            </li>
